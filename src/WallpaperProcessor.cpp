...
const WallpaperProcessor::GradientPreset WallpaperProcessor::s_presets[12] = {
    // name             color1        color2
    // ── Warm tones ──
    { "Horizon",        0xff003973, 0xffe5e5be },  // golden hour warmth
    { "Roseanna",       0xffff4b1f, 0xffff9068 },  // vibrant coral
    { "Burning",        0xffff416c, 0xffff4b2b },  // vivid red-orange
    // ── Cool tones ──
    { "Mint",           0xff00b4db, 0xff0083b0 },  // fresh aqua
    { "Sea",            0xff2b5876, 0xff4e4376 },  // deep oceanic indigo
    { "Trelis",         0xff1cb5e0, 0xff000046 },  // bright cyan to midnight
    // ── Purples & pinks ──
    { "Ultra Violet",   0xff654ea3, 0xffeaafc8 },  // purple to blush
    { "Sublime",        0xfffc466b, 0xff3f5efb },  // pink to electric blue
    // ── Neutrals & dark ──
    { "Royal",          0xff141e30, 0xff243b55 },  // deep navy
    { "Grade Grey",     0xffbdc3c7, 0xff2c3e50 },  // sophisticated mono
    // ── Greens & nature ──
    { "Ver",            0xffffe000, 0xff799f0c },  // lime green
    { "Forest",         0xff5a3f37, 0xff2c7744 },  // deep forest
};
